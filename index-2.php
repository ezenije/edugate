...
<!-- Mirrored from swlabs.co/edugate/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Nov 2020 12:14:12 GMT -->
                    ...
                    <ul class="nav-links nav navbar-nav">
                        <li class="dropdown active"><a href="javascript:void(0)" class="main-menu">Home<span class="fa fa-angle-down icons-dropdown"></span></a>
                            <ul class="dropdown-menu edugate-dropdown-menu-1">
                                <li><a href="index-2.php" class="link-page">Home page 01</a></li>
                                <li><a href="homepage-02.php" class="link-page">Home page 02</a></li>
                                <li><a href="homepage-03.php" class="link-page">Home page 03</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="javascript:void(0)" class="main-menu">Courses<span class="fa fa-angle-down icons-dropdown"></span></a>
                            <ul class="dropdown-menu edugate-dropdown-menu-1">
                                <li><a href="courses.php" class="link-page">courses</a></li>
                                <li><a href="courses-detail.php" class="link-page">course detail</a></li>
                                <li><a href="events.php" class="link-page">events</a></li>
                                <li><a href="event-detail.php" class="link-page">event detail</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="javascript:void(0)" class="main-menu">gallery<span class="fa fa-angle-down icons-dropdown"></span></a>
                            <ul class="dropdown-menu edugate-dropdown-menu-1">
                                <li><a href="gallery-3column.php" class="link-page">gallery 3 column</a></li>
                                <li><a href="gallery-4column.php" class="link-page">gallery 4 column</a></li>
                                <li><a href="gallery-masonry.php" class="link-page">gallery masonry</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="javascript:void(0)" class="main-menu">pages<span class="fa fa-angle-down icons-dropdown"></span></a>
                            <ul class="dropdown-menu edugate-dropdown-menu-1">
                                <li><a href="categories.php" class="link-page">categories</a></li>
                                <li><a href="profile-teacher.php" class="link-page">profile teacher</a></li>
                                <li><a href="about-us.php" class="link-page">about us</a></li>
                                <li><a href="login.php" class="link-page">login</a></li>
                                <li><a href="register.php" class="link-page">register</a></li>
                                <li><a href="404.php" class="link-page">404 page</a></li>
                        ...
                        <li class="dropdown"><a href="javascript:void(0)" class="main-menu">News<span class="fa fa-angle-down icons-dropdown"></span></a>
                            <ul class="dropdown-menu edugate-dropdown-menu-1">
                                <li><a href="news.php" class="link-page">news list</a></li>
                                <li><a href="news-grid.php" class="link-page">news grid</a></li>
                                <li><a href="news-grid-nonsidebar.php" class="link-page">news grid nonsidebar</a></li>
                                <li><a href="news-masonry.php" class="link-page">news masonry</a></li>
                                <li><a href="news-detail.php" class="link-page">news detail</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="slider-1">
                            <div class="slider-caption">
                                <div class="container"><h5 class="text-info-2">You only have to know one thing</h5>
                                    ...
                                    <p class="text-info-3">Easy. For everyone</p>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-1">
                                    <div class="icon-circle">
                                        ...
                                        <div class="info">
                                            <div class="info-back"><a href="courses.php">You already learned one, remember?</a></div>
                                        </div>
                                    </div>
                                    <div class="name-course"><a href="courses.php">Language</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-2">
                                    ...
                                    <div class="name-course"><a href="courses.php">Software</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-3">
                                    ...
                                    <div class="name-course"><a href="courses.php">Social Media</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-4">
                                    ...
                                    <div class="name-course"><a href="courses.php">Photography</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-5">
                                    ...
                                    <div class="name-course"><a href="courses.php">Business</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-6">
                                    ...
                                    <div class="name-course"><a href="courses.php">Communication</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="progress-bars-content">
                            <div class="progress-bar-wrapper"><h2 class="title-2">Some important facts about us</h2>
                                ...
                                <div class="group-button">
                                    <button onclick="window.location.href='categories.php'" class="btn btn-transition-3"><span>Purchase theme</span></button>
                                    <button onclick="window.location.href='about-us.php'" class="btn btn-green-3"><span>start Learn now</span></button>
                                </div>
                                ...
                                <div class="top-courses-item">
                                    <div class="edugate-layout-2">
                                        <div class="edugate-layout-2-wrapper">
                                            <div class="edugate-content"><a href="courses-detail.php" class="title">Photoghaphy Master</a>
                    ...
                    <div class="why-choose-us-wrapper-top">
                        <div class="container">
                            <div class="why-choose-us-wrapper"><h2 class="title-2">Why Edugate?</h2>
                                ...
                                <button onclick="window.location.href='categories.php'" class="btn btn-green-2"><span>start Learn now</span></button>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="latest-news-wrapper">
                            <div class="edugate-layout-1">
                                ...
                                <div class="edugate-content"><a href="news-detail.php" class="title">Effective researching method</a>
                                    ...
                                    <button onclick="window.location.href='news-detail.php'" class="btn btn-green"><span>learn now</span></button>
                                </div>
                            </div>
                            <div class="edugate-layout-1">
            ...
            <div class="hyperlink">
                <div class="pull-left hyper-left">
                    <ul class="list-inline">
                        ...
                        <li><a href="categories.php">PAGES</a></li>
